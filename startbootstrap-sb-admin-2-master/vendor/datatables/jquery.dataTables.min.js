...
fnStateSaveParams:null,iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"Trang đầu",sLast:"Trang cuối",sNext:"Trang kế tiếp",sPrevious:"Trang trước"},sEmptyTable:"Không có dữ liệu",sInfo:"Đang hiển thị _START_ đến _END_ trong số _TOTAL_ thông tin",sInfoEmpty:"Đang có 0 thông tin",sInfoFiltered:"",
sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Hiện _MENU_ thông tin",sLoadingRecords:"Loading...",sProcessing:"Processing...",sSearch:"Tìm kiếm:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"Không tìm được kết quả"},oSearch:h.extend({},n.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",searchDelay:null,sPaginationType:"simple_numbers",sScrollX:"",sScrollXInner:"",sScrollY:"",sServerMethod:"GET",renderer:null,rowId:"DT_RowId"};$(n.defaults);n.defaults.column={aDataSort:null,
